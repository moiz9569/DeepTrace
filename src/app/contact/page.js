      ...
      <div className="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-teal-50 border border-teal-100">
            ...
            <span className="text-sm font-medium text-teal-700">Contact Us</span>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative bg-gradient-to-br from-teal-50 to-emerald-50 rounded-3xl border border-teal-100 p-6">
                <h3 className="text-xl font-bold text-slate-900 mb-4">
                  Premium Support Features
                </h3>
                <div className="space-y-3">
                  {supportFeatures.map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-3 p-3 rounded-xl bg-white/80 border border-white">
                ...
                <div className="mt-6 pt-4 border-t border-teal-100">
                  <p className="text-sm text-slate-600">
                    <span className="font-semibold text-teal-700">Enterprise clients:</span> Dedicated account manager & 24/7 phone support
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <button className="w-full py-3 text-teal-700 font-semibold rounded-xl border border-teal-200 hover:bg-teal-50 transition-colors">
                Visit FAQ Center
              </button>
            </motion.div>
          </div>
