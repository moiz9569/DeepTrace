            ...
            <div className="container mx-auto max-w-6xl p-6 relative z-10">
                ...
                <div className="mt-18 text-center py-12">
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
                        Get in <span className="bg-gradient-to-r from-teal-700 to-teal-800 bg-clip-text text-transparent">Touch</span>
                    </h1>
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-slate-200/60 shadow-sm">
                        Have questions about our AI detection services? Our team is here to help. Reach out for demos, pricing, or technical support.
                    </p>
                </div>
                        ...
                        <div className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-500 overflow-hidden">
                            ...
                            {isSubmitted ? (
                                <div className="p-8 text-center">
                                    <div className="inline-flex p-4 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-2xl mb-6">
                                ...
                                <form onSubmit={handleSubmit} className="p-6">
                                    ...
                                    <button
                                        ...
                                        className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all duration-300 flex items-center justify-center gap-3 ${isSubmitting
                                            ...
                                            : 'bg-gradient-to-r from-teal-800 via-teal-700 to-teal-800  hover:from-teal-700 hover:to-teal-700 shadow-md shadow-emerald-500/30 hover:shadow-md hover:shadow-emerald-500/40'
                                            }`}
                                    >
                                        {isSubmitting ? (
                                            <>
                            ...
                            <div className="border-b border-slate-200/60 bg-gradient-to-r from-white to-slate-50/80 p-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500">Multiple ways to reach us</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    {contactInfo.map((info, index) => (
                                        ...
                                        >
                                            <div className="flex items-start gap-4">
                                                <div className={`p-3 bg-gradient-to-br from-${info.color}-100 to-${info.color}-50 rounded-xl group-hover:scale-110 transition-transform duration-300`}>
