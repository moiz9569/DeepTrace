...
export default function ServicesPage() {
    const services = [
        {
            ...
            description: "AI vs human text classification using state-of-the-art NLP models.",
            features: ["RoBERTa models", "Style analysis", "Plagiarism check", "Sentiment analysis"],
            color: "teal",
            href: "/text-model"
        },
        {
            ...
            description: "Advanced image forensics for detecting manipulated or AI-generated images.",
            features: ["High accuracy", "Metadata analysis", "Pattern recognition", "Watermark detection"],
            color: "emerald",
            href: "/picture-model"
        },
        {
            ...
            description: "Frame-by-frame AI video detection using advanced deep learning models.",
            features: ["Real-time processing", "Multi-format support", "Batch analysis", "API integration"],
            color: "teal",
            href: "/video-model"
        }
    ]
    ...
    const solutions = [
        {
            ...
            description: "End-to-end encrypted analysis with compliance-ready infrastructure.",
            color: "green",
        ...
        },
        {
            icon: Cloud,
            title: "Cloud API",
            description: "Scalable REST API with comprehensive documentation and SDKs.",
            color: "green",
        ...
        },
        {
            ...
            description: "Shared workspaces, role-based access, and collaborative workflows.",
            color: "green",
    ...
    const integrations = [
        ...
        { name: "Python SDK", icon: Layers },
        { name: "Node.js SDK", icon: Database },
        { name: "Webhooks", icon: Zap },
        { name: "Web Dashboard", icon: Cpu },
        { name: "Mobile SDKs", icon: ShieldCheck }
    ]
                ...
                <div className="mt-16 container mx-auto max-w-6xl p-6 relative z-10">
                    ...
                    <div className="text-center py-16 mb-16">
                        ...
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed bg-white/40 backdrop-blur-sm rounded-2xl p-6 border border-white/50">
                            Comprehensive AI-powered verification tools for video, image, and text content. Trusted by enterprises worldwide for accuracy and reliability.
                        </p>
                    </div>
                    ...
                    <div className="rounded-2xl mb-20">
                        <div className="text-center mb-12">
                            <div className="flex items-center justify-center gap-3 mb-4">
                                ...
                                <h2 className="text-3xl font-bold text-slate-900">Core Services</h2>
                            </div>
                            ...
                            {services.map((service, index) => (
                                <Link href={service.href} key={index}>
                                    <div className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 group overflow-hidden">
                                        <div className="p-8">
                                            <div className={`flex items-center justify-center w-16 h-16 bg-gradient-to-br from-${service.color}-100 to-${service.color}-50 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300`}>
                                        ...
                                        <div className={`h-1 bg-gradient-to-r from-${service.color}-500 to-${service.color}-600`}></div>
                                    </div>
                                </Link>
                            ))}
                        </div>
                    ...
                    <div className="mt-16 mb-20">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {solutions.map((solution, index) => (
                                ...
                                >
                                    <div className={`inline-flex p-3 bg-gradient-to-br from-${solution.color}-100 to-${solution.color}-50 rounded-lg mb-4`}>
                    ...
                    {/* CTA Section */}
                    <div className="mt-16 mb-20">
                        <div className="bg-gradient-to-br from-teal-50 to-emerald-50/50 border border-emerald-200/50 rounded-2xl p-12 text-center shadow-sm">
                            ...
                            <p className="text-slate-600 max-w-xl mx-auto mb-8">
                                Start verifying content authenticity with our simple, powerful API. No credit card required.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <button
                                    onClick={handleClick}
                                    className="px-8 py-3 bg-gradient-to-r from-teal-800 via-teal-700 to-teal-800 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-emerald-500/30 transition-all duration-300">
                                    Start Free Trial
                                </button>
