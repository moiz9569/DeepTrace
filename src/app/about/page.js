...
export default function AboutPage() {
  ...
  const stats = [
    { label: "Accuracy", value: "95%", icon: Target, color: "teal" },
    { label: "Processing Speed", value: "<2s", icon: Zap, color: "cyan" },
    { label: "Supported Formats", value: "3", icon: Building2, color: "emerald" },
