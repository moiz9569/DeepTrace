...
export default function AboutPage() {
  const features = [
    { icon: Brain, title: "Custom AI Models", desc: "Proprietary machine learning models for truth detection.", color: "green" },
    { icon: Shield, title: "Enterprise Security", desc: "Bank-grade security with SOC 2 compliance.", color: "green" },
    { icon: Zap, title: "Real-time Processing", desc: "Lightning-fast analysis with sub-second response.", color: "green" },
    { icon: Users, title: "Multi-format Support", desc: "Analysis across video, images, audio, and text.", color: "green" },
  ]
      ...
      <div className="container max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-16">
          <div className="items-center justify-center">
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className="p-3 bg-gradient-to-r from-teal-500 to-emerald-500 bg rounded-lg">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Why Choose DeepTrace</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="font-bold text-lg text-slate-900">Technology Stack</h3>
            </div>

            <div className="flex flex-wrap gap-2">
              {["TensorFlow", "PyTorch", "AWS", "Node.js", "MongoDB", "Docker"].map((tech, i) => (
                <span key={i} className="px-3 py-1 bg-teal-50 text-teal-700 rounded-lg text-sm">
                  {tech}
                </span>
              ))}
            </div>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="font-bold text-lg text-slate-900">Certifications</h3>
            </div>
        ...
        <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-6 py-3 bg-gradient-to-r from-teal-800 via-teal-700 to-teal-800 text-white rounded-xl font-medium hover:bg-teal-700 transition">
              Explore Services
            </button>
