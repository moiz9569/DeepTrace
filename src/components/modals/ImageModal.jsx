  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
        <div className="bg-gradient-to-br from-white to-slate-50 rounded-3xl w-170 max-w-3xl shadow-2xl relative overflow-hidden border border-slate-200 max-h-[90vh] flex flex-col">
          ...
          {/* Header */}
          <div className="relative p-8 border-b border-slate-100 bg-gradient-to-r from-teal-50 to-emerald-50">
          ...
          <div className="flex-1 overflow-y-auto p-8">
            <div className="space-y-6">
              ...
              {!selectedFile ? (
                <div
                  className="border-3 border-dashed border-slate-300 rounded-2xl p-12 text-center cursor-pointer transition-all duration-300 bg-gradient-to-b from-white to-slate-50 hover:border-teal-400 hover:bg-teal-50/30 hover:shadow-lg"
                  onClick={() => fileInputRef.current?.click()}
                  onDragOver={handleDragOver}
                  onDrop={handleDrop}
                >
                  <div className="p-4 bg-gradient-to-r from-teal-100 to-emerald-100 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center">
                  ...
                  <button className="px-6 py-2.5 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-lg hover:from-teal-700 hover:to-emerald-700 transition-all shadow-sm">
                    Choose File
                  </button>
                    ...
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl font-semibold text-white flex items-center justify-center gap-2 transition-all relative overflow-hidden
                        ${isAnalyzing
                          ...
                          : "bg-gradient-to-r from-teal-700 via-teal-600 to-emerald-700 hover:from-teal-800 hover:to-emerald-800 hover:shadow-lg active:scale-[0.99] shadow-md"
                        }`}
                    >
