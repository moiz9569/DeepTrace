  ...
  const sections = [
    {
      ...
      items: [
        ...
        { label: "Traffic", icon: BarChart3, path: "/dashboard/user/traffic" },
      ],
    },
    {
      title: "MANAGEMENT",
      ...
      rounded-full text-sm text-emerald-700 shadow-sm"
          ...
          text-white shadow-md transition-all"
            ...
            {/* <button
              ...
              className="px-6 cursor-pointer py-2.5 rounded-full text-sm font-medium 
        text-white bg-rose-600 hover:bg-rose-700 
        transition-all shadow-md 
        disabled:opacity-60 disabled:cursor-not-allowed
        flex items-center gap-2 min-w-22.5"
            >
              {logoutLoading ? (
                <>
          ...
          <div className="p-3 border-t border-teal-800" ref={userMenuRef}>
            ...
            >
             ...
             <button
                  ...
                  className="flex items-center cursor-pointer gap-3 w-full px-4 py-2.5 text-sm text-white hover:text-gray-300 transition-colors"
                >
